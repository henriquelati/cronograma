        ...
        "<div class='col-md-8'>"+
            "<div class='clndr-controls'>" +
                "<div class='clndr-control-button'>" +
                    "<span class='clndr-previous-button'><i class='fa fa-arrow-left fa-2x' aria-hidden='true'></i></span>" +
                "</div>" +
                "<div class='month' style='font-size: 140%;'><%= month %> <%= year %></div>" +
                "<div class='clndr-control-button rightalign'>" +
                    "<span class='clndr-next-button'><i class='fa fa-arrow-right fa-2x' aria-hidden='true'></i></span>" +
                "</div>" +
            "</div>" +
        "</div>" +
        "<div class='col-md-8'>"+
            "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
                "<thead>" +
                    ...
                    "<% for(var i = 0; i < daysOfTheWeek.length; i++) { %>" +
                        "<td class='w3-td header-day' style='font-size: 160%;'><b><%= daysOfTheWeek[i] %></b></td>" +
                    "<% } %>" +
                    "</tr>" +
                "</thead>" +
                "<tbody>" +
